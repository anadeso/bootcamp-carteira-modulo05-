...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private AutentitacaoService autenticacaoService;
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/v3/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/security", "/swagger-ui.html", "/webjars/**");
    }
